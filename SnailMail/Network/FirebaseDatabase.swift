...
func saveNameToDatabase(name: String, completion: @escaping (_ success: Bool, _ error: String?) -> Void) {
    saveDataInDatabase(data: [kNAME: name]) { (success, error) in
        if let error = error {
            completion(success, error)
        }
        completion(true, nil) //if successful
    }
}

func saveDataInDatabase(data: [String: Any], completion: @escaping (_ success: Bool, _ error: String?) -> Void) {
